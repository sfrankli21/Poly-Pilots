...
namespace AerodynamicObjects.Demos
{
    ...
    {
        readonly string summary = "The Model Glider is a simple aircraft modelled with two Aerodynamic Object panels for the wings and one each for the tailplane and fin.";
