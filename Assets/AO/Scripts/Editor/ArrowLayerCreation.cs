...
{
    /// <summary>
    /// Automatically creates a layer for the arrows in Unity.
    /// </summary>
    [InitializeOnLoad]
    public class ArrowLayerCreation
    {
        ...
        {
            // ====================
            // The code below was adapted from: https://forum.unity.com/threads/create-tags-and-layers-in-the-editor-using-script-both-edit-and-runtime-modes.732119/
